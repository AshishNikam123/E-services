...
function Blood(){
    ...
    const columns=[
        {dataField:'userName',text:'Donor Name'},
        {dataField:'service_Info.servicename',text:'Blood Group',sort:true,filter:textFilter()},
    ...
    return <div > 
        <Base>
        <div><h1> Blood Donors Available Near You...</h1>
        </div>
   <BootstrapTable 
   bootstrap4 
